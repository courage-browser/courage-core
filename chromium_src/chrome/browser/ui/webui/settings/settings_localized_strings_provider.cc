...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  webui::LocalizedString localized_strings[] = {
      ...
      {"siteSettingsAutoplayAsk", IDS_SETTINGS_SITE_SETTINGS_AUTOPLAY_ASK},
      ...
      {"allowAllFingerprinting", IDS_SETTINGS_ALLOW_FINGERPRINTING},
      {"blockAllFingerprinting", IDS_SETTINGS_BLOCK_FINGERPRINTING},
      ...
      {"braveSyncLabel", IDS_SETTINGS_BRAVE_SYNC_LINK_LABEL},
      ...
      {"remoteDebuggingEnabledTitle", IDS_SETTINGS_REMOTE_DEBUGGING_TITLE},
