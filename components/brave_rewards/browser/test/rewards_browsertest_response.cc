...
#include "brave/components/brave_rewards/browser/test/rewards_browsertest_response.h" // NOLINT
#include "brave/components/brave_rewards/browser/test/rewards_browsertest_network_util.h" // NOLINT
...
bool RewardsBrowserTestResponse::WasRequestMade() {
  return request_made_;
}
